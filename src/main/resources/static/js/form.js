                                ...
                                rows: [
                                    ...
                                    },
                                    {
                                        ...
                                        value: '№\tНаименование органа власти\tОписание\n' +
                                            ...
                                            '16\tУправление ветеринарии\tВетеринарные клиники, ветеринарные аптеки, ветеринарные кабинеты, зоомагазины, организации, занимающиеся отловом животных без владельцев\n '  +
                                            '17\tУправление МЧС по РБ\t Организации, осуществляющие деятельность в сфере противопожарной безопасности \n' +
                                            '18\tРосгвардия\tЧастные охранные предприятия\n' +
                                            '19\tКомитет по межнациональным отношениям и развитию гражданских инициатив АГИП - деятельность религиозных организаций в целях совместного исповедания и распространения веры, в том числе реализация религиозными организациями предметов религиозного назначения и религиозной литературы\n' +
                                            '20\tБурприроднадзор\tЮридические лица и (или) индивидуальные предприниматели, осуществляющие охотхозяйственную деятельность, мероприятия по защите охотничьих ресурсов от болезней, а также мероприятия по добыче охотничьих животных в целях предотвращения нанесения ущерба здоровью граждан, возникновения и распространения болезней охотничьих ресурсов, ущерба объектам животного мира и среде их обитания посредством проведения охоты в целях регулирования численности охотничьих ресурсов, охоты в целях научно-исследовательской деятельности\n'
                                    }
                                ]
                            }
                        ]
...
*/
                    ...
                    },
                    {
                        ...
                        readonly: true,
                        scroll: true,
                        template: 'СОГЛАСИЕ на обработку персональных данных (далее – «Согласие»)\n' +
