                                ...
                                rows: [
                                    ...
                                    },
                                    {
                                        ...
                                        options: [
                                            ...
                                            { id: 17, value: 'Респ. агентство ГО и ЧС (Организации, осуществляющие деятельность в сфере противопожарной безопасности)'},
                                            { id: 18, value: 'Комитет спец. программ АГиП РБ (Частные охранные предприятия)'},
                                        ]
                                    },
                                    {
                                        view: 'textarea',
...
*/
                    ...
                    },
                    {
                        ...
                        template: '<p style="text-align: center;"><strong>ПРЕДПИСАНИЕ&nbsp;Управления Роспотребнадзора по Республике Бурятия</strong></p>\n' +
                            ...
                            '<p>Ответственность за выполнение предписания возлагается на хозяйствующий субъект, получивший в ЕИС &laquo;Работающая Бурятия&raquo; разрешение на работу в период самоизоляции.</p>\n' +
                            '<p style="text-align: center;">должность, фамилия, имя, отчество должностного лица либо гражданина</p>\n' +
                            '<p>О мерах, принятых во исполнение предписания сообщить в адрес Управления Роспотребнадзора по Республике Бурятия не позднее 3х дней с момента получения в ЕИС &laquo;Работающая Бурятия&raquo; разрешения на работу по электронной почте: <a href="mailto:org@03.rospotrebnadzor.ru. ">org@03.rospotrebnadzor.ru. </a></p>\n' +
