...
webix.ready(function() {
    webix.ui({
        ...
        rows: [
            ...
            {
                view: 'label',
                label: '<span>Уважаемые пользователи!</span>',
                //css: 'main_label'
            },
            {
                view: 'label',
                label: '<span>При подаче заявки на 100 и более человек обязательно используйте шаблон для заполнения! ' +
                    '<a href="http://работающаябурятия.рф/zayvka.xlsx" target="_blank">Скачать шаблон</a> </span>'
                //css: 'main_label'
            },
            {
                view: 'label',
                label: '<span>Ссылка на для загрузки данных по форме шаблона будет добавлена на форме заявки с 13.04.2020 г</span>',
                //css: 'main_label'
            },
            {
                id: 'form',
                ...
                elements: [
                    ...
                    },
                    {
                        ...
                        readonly: true,
                        scroll:true,
                        template: '<b>ПРЕДПИСАНИЕ УПРАВЛЕНИЯ РОСПОТРЕБНАДЗОРА ПО РЕСПУБЛИКЕ БУРЯТИЯ</b> <br/>'+
                            '<br/>' +
