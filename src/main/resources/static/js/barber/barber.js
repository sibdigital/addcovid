...
*/
                    ...
                    },
                    {
                        ...
                        template:
                            ...
                            '<p style="text-align: center;"><strong>Методические рекомендации (требования) по профилактике новой коронавирусной инфекции (COVID-19) среди должностных лиц и работников организаций коммунально-бытового назначения,&nbsp;</strong><strong>оказывающих парикмахерские услуги</strong></p>\n' +
                            '<p><strong>&nbsp;</strong></p>\n' +
                            '<ol>\n' +
                            ...
                            '</ol>\n' +
                            '<p style="padding-left: 60px;">5.1. Обслуживать клиентов только по предварительной записи, не позволяя клиенту долго оставаться в комнате ожидания или в основном помещении (более 15 минут);</p>\n' +
                            '<p style="padding-left: 60px;">5.2. Не предоставлять услуги клиентам:</p>\n' +
                            '<p style="padding-left: 60px;">5.2.1. в домашних условиях или выезжать к клиенту.</p>\n' +
                            '<p style="padding-left: 60px;">5.2.2. если он соответствует какой-либо из групп лиц, которые обязаны соблюдать самоизоляцию, изоляцию в домашних условиях по постановлению санитарных врачей по Республике Бурятия;</p>\n' +
                            '<p style="padding-left: 60px;">5.2.3. при наличии у него признаков респираторной инфекции.</p>\n' +
                            '<p style="padding-left: 60px;">5.3. Рабочие места должны быть расположены таким образом, чтобы в пределах 1,5 метров не было другого рабочего места, а также места ожидания для клиентов. Если это условие не может быть выполнено, то одновременно разрешается обслуживать лишь столько клиентов, сколько позволяет расположение рабочего места с соблюдением дистанции в 1,5 метра;</p>\n' +
                            '<p style="padding-left: 60px;">5.4. Перед записью информировать клиента о необходимости сохранения информации о нем (имя, фамилия, телефон) для эпидемиологического расследования, если такая необходимость возникнет.</p>\n' +
                            '<p style="padding-left: 30px;">6.Поставщики парикмахерских услуг&nbsp;должны соблюдать следующие меры безопасности и гигиены:</p>\n' +
                            '<p style="padding-left: 60px;">6.1. обеспечить при входе работников и посетителей в организации коммунально-бытового назначения, оказывающих парикмахерские услуги возможность обработки рук кожными антисептиками или дезинфицирующими салфетками, предназначенными для этих целей с установлением контроля за соблюдением данной гигиенической процедуры.</p>\n' +
                            '<p style="padding-left: 60px;">6.2. Осуществлять деятельность с использованием средств индивидуальной защиты (маски, перчатки)</p>\n' +
                            '<p style="padding-left: 60px;">6.3. Регулярно дезинфицировать часто используемые поверхности (дверные ручки, краны, унитазы, поверхности столов, подлокотники кресел, электронные устройства) и помещения. Для дезинфекции могут быть использованы средства из различных химических групп: хлорактивные (хлорамин Б &ndash; в концентрации активного хлора в рабочем растворе не менее 3,0%), кислородактивные (перекись водорода &ndash; в концентрации не менее 3,0%), спирты (в качестве кожных антисептиков и дезинфицирующих средств для обработки небольших по площади поверхностей &ndash; изопропиловый спирт в концентрации не менее 70% по массе, этиловый спирт в концентрации не менее 75% по массе).</p>\n' +
                            '<p style="padding-left: 60px;">6.4. Мыть и дезинфицировать руки, даже если во время обслуживания использовались резиновые перчатки;</p>\n' +
                            '<p style="padding-left: 60px;">6.5. обеспечить регулярное проветривание рабочих помещений с периодичностью каждые 2 часа; использовать в рабочих помещениях бактерицидные лампы, рециркуляторы воздуха закрытого типа с целью регулярного обеззараживания воздуха (по возможности);</p>\n' +
                            '<ol start="7">\n' +
                            '<li>Поставщикам услуг рекомендуется следовать новостям и рекомендациям на сайте&nbsp;Управления Роспотребнадзора по Республике Бурятия.</li>\n' +
                            '</ol>'
                    },
                    {
                        view: 'checkbox',
