...
public class BarberAddPage {
    ...
    private final HTMLComponent organizationShortName;
    private final HTMLComponent organizationInn;
    private final HTMLComponent organizationOgrn;
    private final HTMLComponent organizationEmail;
    ...
    private final HTMLComponent reqBasis;
    private final HTMLComponent upload;

    private final HTMLComponent personSlrySaveCnt;
    private final HTMLComponent personRemoteCnt;
    private final HTMLComponent personOfficeCnt;

    private final HTMLComponent peopleTable;


    private final HTMLComponent isAgree;
    private final HTMLComponent isProtect;
    private final HTMLComponent sendBtn;

    private final HTMLComponent errorPane;
